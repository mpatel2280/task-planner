class SetupSolidQueue < ActiveRecord::Migration[8.0]
  def up
    ...
    # Table for pausing/resuming queues
    ...
    # Table for concurrency management (semaphores)
    ...
    # For jobs blocked by concurrency limits (semaphores)
    create_table "solid_queue_blocked_executions", force: :cascade do |t|
      t.bigint "job_id", null: false
      t.string "queue_name", null: false     # <--- Ensure this is here
      t.integer "priority", default: 0, null: false # <--- Solid Queue 1.0 requires this
      t.string "concurrency_key", null: false
      t.datetime "expires_at", null: false
      t.datetime "created_at", null: false
      t.index ["concurrency_key", "priority", "job_id"], name: "index_solid_queue_blocked_executions_for_release"
      t.index ["expires_at"], name: "index_solid_queue_blocked_executions_for_maintenance"
      t.index ["job_id"], name: "index_solid_queue_blocked_executions_on_job_id", unique: true
    end


    # Note: Adding just the core tables to get bin/jobs running. 
    # You can add others (failed_executions, claimed_executions) as needed.
  end
